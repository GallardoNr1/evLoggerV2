...
export const FuelComparisonChart = ({ sessions, settings }: FuelComparisonChartProps) => {
  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-4">
      <h3 className="mb-2 font-semibold text-foreground">Eléctrico vs. Combustible</h3>
      <p className="mb-4 text-xs text-muted-foreground">Comparativa de costes mensuales</p>
          ...
          <BarChart data={monthlyData} barGap={4}>
            ...
            <Tooltip
              ...
              formatter={(value: number, name: string) => [
                `${value.toFixed(2)}€`,
                name === 'electricCost' ? 'Eléctrico' : 'Combustible'
              ]}
            />
            <Bar 
      ...
      <div className="mt-4 flex items-center justify-center gap-6 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-primary">{totalElectric.toFixed(2)}€</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5">
          ...
          <span className="font-semibold text-destructive">{totalFuel.toFixed(2)}€</span>
        </div>
      </div>
